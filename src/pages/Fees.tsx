      ...
      <div className="container-custom py-12">
        ...
        <Tabs defaultValue="booie">
          <TabsList className="mb-8">
            <TabsTrigger value="booie">Booie Fee Structure</TabsTrigger>
            <TabsTrigger value="comparison">Comparison with Others</TabsTrigger>
            <TabsTrigger value="examples">Fee Examples</TabsTrigger>
          </TabsList>
          
          <TabsContent value="booie">
            <Card>
              <CardHeader>
