...
import { 
  ...
  AnalysisSummary,
  ProgramInputs 
} from '@/components/income-projection';
          ...
          <div className="md:col-span-2">
            <Card className="h-full">
              ...
              <CardContent className="p-6">
                <ProjectionChart 
                  projectionData={isComparing ? comparisonData : projectionData}
                  isComparing={isComparing}
                  selectedDegreeObj={selectedDegreeObj}
                  selectedSchoolObj={selectedSchoolObj}
                  comparisonDegreeObj={comparisonDegreeObj}
                  comparisonSchoolObj={comparisonSchoolObj}
